...
export function Hero() {
  return (
    <section className="flex w-full flex-col items-center gap-16 lg:gap-[72px]">
      <div className="flex w-full flex-col items-center justify-center gap-8 overflow-hidden bg-[linear-gradient(180deg,#fff_18%,rgba(140,0,255,0.35)_100%)] pt-[120px] pb-16 lg:gap-12 lg:pt-[140px] lg:pb-20">
