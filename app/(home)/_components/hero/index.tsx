 ...
 * full-bleed gradient block (`#fff 18%` → `rgba(171,255,89,.5)`) with
 * `overflow: hidden`, and the strip 72px below it.
 */
export function Hero() {
  return (
    <section className="flex w-full flex-col items-center gap-16 lg:gap-[72px]">
      <div className="flex w-full flex-col items-center justify-center gap-8 overflow-hidden bg-[linear-gradient(180deg,#fff_18%,rgba(171,255,89,0.5)_100%)] pt-[120px] lg:gap-12 lg:pt-[140px]">
