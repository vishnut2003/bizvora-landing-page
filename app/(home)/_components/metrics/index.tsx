...
export function Metrics() {
  return (
    <section className="flex w-full max-w-[500px] justify-center px-5 md:max-w-[900px] md:px-10 lg:max-w-[1200px] lg:px-16">
      <div className="flex w-full flex-col gap-10 rounded-[24px] bg-[linear-gradient(118deg,rgba(171,255,89,0.3)_0%,rgb(108,211,255)_216%)] px-7 pt-[31px] pb-10 lg:flex-row lg:items-center lg:gap-[54px] lg:py-12">
